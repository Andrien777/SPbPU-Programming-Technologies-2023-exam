>How to live in the world, where humanity tryes to simplify everything, but it doesn't work at all? © В.В. Алина, 2023
...
Теперь мы подошли к моменту, когда стоит рассказать о грустном. Java не знает про дженерики ничего во время исполнения кода. Это реализовано по историческим причинам в том, числе из-за позиционирования языка _Write Once, Run Anywhere_. Механизм из-за которого это происходит называется стирание типов или type erasure.
...
По-хорошему, стоит добавить пару слов о `Wildcards`, но вы итак уже [устали](>How to live in the world, where humanity tryes to simplify everything, but it doesn't work at all? © В.В. Алина, 2023
...
По-хорошему, стоит добавить пару слов о `Wildcards`, но вы итак уже [устали](https://docs.oracle.com/javase/tutorial/java/generics/wildcards.html).
